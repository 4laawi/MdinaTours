...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return {
        title,
        description,
        alternates: getAlternates(lang, '/private-driver-sale'),
        openGraph: {
            title,
            description,
            url,
...
export default async function PrivateDriverSalePage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const serviceJsonLd = {
        ...
        "url": `https://mdinatours.com/${language}/private-driver-sale`,
        "provider": {
            "@type": "LocalBusiness",
            "name": "Mdina Tours",
            "image": "https://mdinatours.com/img2/rabat-hassan-tour.jpg",
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "position": 3,
                "name": "Salé",
                "item": `https://mdinatours.com/${language}/private-driver-sale`
            }
        ]
    };
