...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return {
        title,
        description,
        alternates: getAlternates(lang, '/private-driver-marrakech'),
        openGraph: {
            title,
            description,
            url,
...
export default async function PrivateDriverMarrakechPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const serviceJsonLd = {
        ...
        "url": `https://mdinatours.com/${language}/private-driver-marrakech`,
        "provider": {
            "@type": "LocalBusiness",
            "name": "Mdina Tours",
            "image": "https://mdinatours.com/hero-marrakech.webp",
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "position": 3,
                "name": "Marrakech",
                "item": `https://mdinatours.com/${language}/private-driver-marrakech`
            }
        ]
    };
