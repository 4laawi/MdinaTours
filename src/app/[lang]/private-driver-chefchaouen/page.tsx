...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return {
        title,
        description,
        alternates: getAlternates(lang, '/private-driver-chefchaouen'),
        openGraph: {
            title,
            description,
            url,
...
export default async function PrivateDriverChefchaouenPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const serviceJsonLd = {
        ...
        "url": `https://mdinatours.com/${language}/private-driver-chefchaouen`,
        "provider": {
            "@type": "LocalBusiness",
            "name": "Mdina Tours",
            "image": "https://mdinatours.com/hero-chefchaouen.webp",
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "position": 3,
                "name": "Chefchaouen",
                "item": `https://mdinatours.com/${language}/private-driver-chefchaouen`
            }
        ]
    };
