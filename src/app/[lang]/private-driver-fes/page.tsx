...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return {
        title,
        description,
        alternates: getAlternates(lang, '/private-driver-fes'),
        openGraph: {
            title,
            description,
            url,
...
export default async function PrivateDriverFesPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const serviceJsonLd = {
        ...
        "url": `https://mdinatours.com/${language}/private-driver-fes`,
        "provider": {
            "@type": "LocalBusiness",
            "name": "Mdina Tours",
            "image": "https://mdinatours.com/img2/fes_gate.jpg",
    ...
    const breadcrumbJsonLd = {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "position": 3,
                "name": "Fes",
                "item": `https://mdinatours.com/${language}/private-driver-fes`
            }
        ]
    };
