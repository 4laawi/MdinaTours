...
import styles from './MdinaToursSection.module.css';

export default function MdinaToursSection({ lang = 'en' }: { lang?: Language }) {
    const t = (key: string) => {
                    ...
                    <div className={styles.mainImageCol}>
                        <div className={styles.imageWrapper}>
                            <Image
                                ...
                                alt="Moroccan Medina Architecture"
                                fill
                        ...
                        <div className={styles.bottomRow}>
                            ...
                            <div className={styles.infoCard}>
                                ...
                                <div className={styles.cardContent}>
                                    ...
                                    <span className={styles.cardSubtitle}>{t('zt_card_subtitle')}</span>
                                </div>
                            </div>
                        </div>
                    </div>
