            ...
            <div className={styles.footerContent}>
                ...
                <div className={styles.column}>
                    <div className={styles.logoWrapper}>
                        <Link href={getPath('/')} aria-label="Mdina Tours Homepage">
                            <svg viewBox="0 0 280 80" width="180" height="50" className={styles.logoSvg}>
                                ...
                                <text x="65" y="38" fontFamily="'Cormorant Garamond', serif" fontSize="26" fontWeight="bold" fill="#ffffff" letterSpacing="1">Mdina</text>
                ...
                <div className={styles.column}>
                    ...
                    <div className={styles.contactInfo}>
                        <div className={styles.contactItem}>
                            ...
                            <span>Avenue Mohammed V, Rabat, Morocco 10000</span>
                        </div>
                        <div className={styles.contactItem}>
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className={styles.contactItem}>
                            ...
                            <span>booking@mdinatours.com</span>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.column}>
                    ...
                    <div className={styles.socialGrid}>
                        <a href="https://facebook.com/mdinatours" target="_blank" className={styles.socialIcon} aria-label="Facebook">
                            <svg viewBox="0 0 512 512"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" /></svg>
                        </a>
                        <a href="https://instagram.com/mdinatours" target="_blank" className={styles.socialIcon} aria-label="Instagram">
            ...
            <div className={styles.bottomSection}>
                <div className={styles.bottomContainer}>
                    <div className={styles.copyright}>
                        &copy; {currentYear} Mdina Tours Company. {t('footer_built_by')} <a href="https://sitepro.ma" target="_blank" rel="noopener noreferrer" className={styles.agencyLink}>SitePro.ma - Web Agency Morocco</a>
                    </div>
